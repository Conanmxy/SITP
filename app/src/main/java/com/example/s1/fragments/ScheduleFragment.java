...
public class ScheduleFragment extends Fragment {
    ...
    private void initializeData() {
        dbHelper = new MyDatabaseHelper(this.getContext(),"schedule.db",null,1);
    ...
    private void init() {
        ...
        mListView = (ExpandableListView) getActivity().findViewById(R.id.list);
        //mScrollView = (ScrollView) getActivity().findViewById(R.id.scroll);
        calendar.setSelectMore(false); //单选

        calendarLeft = (ImageButton) getActivity().findViewById(R.id.calendarLeft);
        calendarCenter = (TextView) getActivity().findViewById(R.id.calendarCenter);
        calendarRight = (ImageButton) getActivity().findViewById(R.id.calendarRight);
        adapter = new ContactsInfoAdapter(group, child, getActivity(), getStrings(calendar.getYearAndmonthAndDate()), calendar.getNowWeek());
